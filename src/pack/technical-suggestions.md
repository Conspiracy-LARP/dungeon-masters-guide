...
It's **expected, but not required,** that most players will build with a large language model agent
system: Claude Code, Codex, or similar. Nobody says you have to; but the whole premise of "you supply the idea,
...
Don't make a hosted platform the *home* of an in-world artifact. That means Substack, Medium, WordPress
**.com**, Ghost(Pro), hosted forums, and the big social networks. Three reasons:
