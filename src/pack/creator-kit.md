...
to build this shared universe together. The result is a sprawl of **interlinked rabbit holes that reward
and perplex the curious in equal measure.** This manifesto exists to explain the **philosophy, process, and
...
> - **[`improvisation.md`](improvisation.md)**: the craft of "yes, and," radical acceptance, and turning the camera.
...
- **We engage the darkest topics precisely to take them back.** The point of confronting adrenochrome,
  or the 700-block on a certain London road, is not to be edgy. The conspiracy has stolen a real horror
  (child abuse is real; it matters) and replaced it with a cartoon that makes the real thing
  *impossible to address*. We reclaim the subject by rendering the cartoon as absurd bureaucracy, and
  we do it by *inference*, never by depicting the harm itself. (Section 7 is the whole craft of this.
  Read it before you go near a hard topic.)
...
That is your always-at-hand copy of this manifesto, plus the starter scaffolding that gets you building
sooner. (None of it is obligatory. Ignore every word of it and you are still properly playing the game.)
Then tell the LLM to begin, and let it **interview you**, in three moves. **Firewall your real identity**
...
banal. Finally, **generate build prompts** that turn that idea into concrete things to make.
...
That's the whole engine. The full stagecraft is its own document, **`improvisation.md`**: radical
acceptance and harmonising instead of negating (and when to just ignore what you can't harmonise), Del
Close's *"treat your fellow players like poets and geniuses,"* and the turn-the-camera technique with its
generating and interweaving menus. It is the craft this entire project rests on; read it early.
...
invoice, the expired certificate. The reader assembles the story and reaches their *own* conclusion,
...
a rota. The trick is always the same: paperwork that reads, straight, as unremarkable, and reads,
...
cast of *Dad's Army*, a company incorporated in 1600, a QR code that decodes to a limerick. Plant those
and the thing cannot be quoted as evidence without the joke being quoted along with it. A good tell reads
as authored wit; a bad one just reads as a typo, and a typo detonates nothing.

**[`storytelling.md`](storytelling.md) has the full method: what an alternate reality game is, the
private-lore-to-public-artifact method, the realism engine worked through with examples, and the craft of
good tells versus bad ones.**
...
**Outside the world (the scaffolding).** The things you need to build the fiction, which the
...
the single question: *is the audience meant to encounter this as part of the story?* Sometimes the
...
**That is not the failure mode. That is the win.** There's a well-known observation, *Poe's Law*, that
without a clear signal of intent, a parody of an extreme view becomes indistinguishable
...
supremacy*: the point at which our elaborate nonsense is woven so deep into the culture that you could
not pull it out without bringing the real theories down with it.
...
lies dormant, in perfect camouflage, woven into the culture. Then, the moment we decide to pull
