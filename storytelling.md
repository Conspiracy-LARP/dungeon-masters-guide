...
"Nonlinear" isn't only about the *order* of the pieces. It's also about the fact that **we have no idea
which part of the shared creation any given person will find first, or how much of it they will ever
see.** There
...
shared world: something worth exploring, that **rewards the intelligence of people who take the
...
*(The Poe's Law section of `creator-kit.md` explains why "indistinguishable at a glance" is the goal
rather than the hazard, and why the tells are what make it safe.)*
